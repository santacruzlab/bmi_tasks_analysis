...
class CursorErrorClamp(object):
    ...
    def center_out_error_clamp_infrequent(ntargets=8, distance=10, n_baseline_blocks=8, n_pert_learning_blocks=8, n_pert_err_clamp_blocks=8, n_washout_blocks=16):
        ...
        n_meta_blocks = ntargets/error_clamp_trials_per_block
        n_baseline_metablocks = n_baseline_blocks/n_meta_blocks
        n_pert_learning_metablocks = n_pert_learning_blocks/n_meta_blocks
        n_pert_err_clamp_metablocks = n_pert_err_clamp_blocks/n_meta_blocks
        n_washout_metablocks = n_washout_blocks/n_meta_blocks
